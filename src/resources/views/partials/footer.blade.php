<!--Footer-->
<footer class="bg-white only_screen">
    <div class="container mx-auto  px-8">
        ...
        <div class="w-full flex flex-col md:flex-row py-6">
            ...
            <div class="flex-1 mb-6">
                ...
                <a class="text-gray-600 no-underline hover:no-underline "  href="https://undraw.co/">
                    images by undraw.co
                </a>
                <a class="text-gray-600 no-underline hover:no-underline "  href="https://github.com/tailwindtoolbox/Landing-Page">
                    template by tailwindtoolbox
                </a>
            </div>
            <!--
            <div class="flex-1">
